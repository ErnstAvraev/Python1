...
# 3.Вагоны в электричке пронумерованы натуральными числами, начиная с 1
...
# обнаружил, что его вагон имеет номер j. Он хочет определить, сколько всего вагонов
...
# if i == j:
#     print('Недостаточно данных, без дополнительной информации вычислить невозможно!')
# else:
#     print((i+j)-1)
